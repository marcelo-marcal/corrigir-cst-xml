...
export function NfseCfopPage() {
    ...
    return (
        ...
        <section className="stepper-grid">
            ...
            descricao={mensagem}
            icone="🛠"
            arquivoIcone="chave-inglesa-white.png"
            >
            <button
                type="button"
                className="primary-button"
        ...
        <section className="kpi-grid">
            ...
            icone="▤"
            variante="orange"
            arquivoIcone="document-orange.png"
            />
            ...
            icone="⌂"
            variante="teal"
            arquivoIcone="home-turquoise.png"
            />
            ...
            icone="⇄"
            variante="blue"
            arquivoIcone="esquerda-direita-teal.png"
            />
            ...
            icone="⚠"
            variante="purple"
            arquivoIcone="warning-purple.png"
            />
        </section>
